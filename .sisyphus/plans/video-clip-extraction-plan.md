...
> 本文档包含详细的项目规划和任务分解。
>
> 项目背景、技术栈、架构概览等上下文信息请参见 `AGENTS.md`。
...
#### 里程碑 1: MVP v0.1 测试发布（Day 18-21）

**时间点**：Phase 0-5完成后（Day 1-14）+ 4天集成测试缓冲 + 3天优化

**发布范围**：

- **阶段1 - 内测（Day 18-20）**：内部Alpha测试，面向开发者和早期反馈用户
- **阶段2 - 公测（Day 21+）**：公开Beta测试，面向更广泛用户
- CLI版本完整功能 + 轻量使用文档
- 已知问题列表
...
- npm包发布（阶段1: @internal scope；阶段2: public scope）
- GitHub Release（tag: v0.1.0-alpha / v0.1.0-beta）
- 内部测试邀请（3-5个种子用户）
- 反馈收集机制（Issue模板）
- 宣发内容（社交媒体、技术社区）
- 反馈渠道强化（Discord/微信群）
